...
PLAY_ITEM = [1/2,49/72,MAIN_MENU_ITEM_FONT_SIZE,"Jouer","white",True]
HIGHSCORE_ITEM = [1/2,31/72,MAIN_MENU_ITEM_FONT_SIZE,"Highscores","white",True]
QUIT_ITEM = [1/2,13/72,MAIN_MENU_ITEM_FONT_SIZE,"Quitter","white",True]
